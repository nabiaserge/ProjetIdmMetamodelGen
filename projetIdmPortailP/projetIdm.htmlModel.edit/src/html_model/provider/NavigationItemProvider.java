...
/**
 * This is the item provider adapter for a {@link html_model.Navigation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationItemProvider extends ContainableTextElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Navigation_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Navigation_type_feature", "_UI_Navigation_type"),
				 Html_modelPackage.Literals.NAVIGATION__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addTextContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Navigation_textContent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Navigation_textContent_feature", "_UI_Navigation_type"),
				 Html_modelPackage.Literals.NAVIGATION__TEXT_CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Html_modelPackage.Literals.NAVIGATION__GROUPED_ITEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Html_modelPackage.Literals.NAVIGATION__GROUPED_ITEMS,
