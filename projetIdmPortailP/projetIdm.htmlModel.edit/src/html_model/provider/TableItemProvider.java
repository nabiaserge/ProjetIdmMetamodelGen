...
/**
 * This is the item provider adapter for a {@link html_model.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends PageContentItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Html_modelPackage.Literals.TABLE__TABLESECTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case Html_modelPackage.TABLE__TABLESECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Html_modelPackage.Literals.TABLE__TABLESECTIONS,
				 Html_modelFactory.eINSTANCE.createTableHead()));

		newChildDescriptors.add
			(createChildParameter
				(Html_modelPackage.Literals.TABLE__TABLESECTIONS,
				 Html_modelFactory.eINSTANCE.createTableBody()));

		newChildDescriptors.add
			(createChildParameter
				(Html_modelPackage.Literals.TABLE__TABLESECTIONS,
				 Html_modelFactory.eINSTANCE.createTableSeparator()));
	}
