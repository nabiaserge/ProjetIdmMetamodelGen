 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrap.impl.ContainerImpl#getPagecontents <em>Pagecontents</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ContainerImpl extends PageContentImpl implements bootstrap.Container {
	/**
	...
	public EList<PageContent> getPagecontents() {
		if (pagecontents == null) {
			pagecontents = new EObjectContainmentEList<PageContent>(PageContent.class, this, BootstrapPackage.CONTAINER__PAGECONTENTS);
		}
		return pagecontents;
	}
