 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrap.impl.ButtonStyleImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ButtonStyleImpl extends ButtonPropertyImpl implements ButtonStyle {
	...
	protected EClass eStaticClass() {
		return BootstrapPackage.Literals.BUTTON_STYLE;
	}
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BootstrapPackage.BUTTON_STYLE__COLOR, oldColor, color));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BootstrapPackage.BUTTON_STYLE__COLOR:
				return getColor();
		}
