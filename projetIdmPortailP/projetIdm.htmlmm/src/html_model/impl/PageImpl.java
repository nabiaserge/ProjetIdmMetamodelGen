 ...
 * </p>
 * <ul>
 *   <li>{@link html_model.impl.PageImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link html_model.impl.PageImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	protected EClass eStaticClass() {
		return Html_modelPackage.Literals.PAGE;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Html_modelPackage.PAGE__TITLE, oldTitle, title));
	}
	...
	public EList<PageContent> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<PageContent>(PageContent.class, this, Html_modelPackage.PAGE__CONTENTS);
		}
		return contents;
	}
