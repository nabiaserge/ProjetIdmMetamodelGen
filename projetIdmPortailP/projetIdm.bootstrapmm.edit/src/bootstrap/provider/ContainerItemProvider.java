...
/**
 * This is the item provider adapter for a {@link bootstrap.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends PageContentItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Container.class)) {
			case BootstrapPackage.CONTAINER__PAGECONTENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createItalic()));

		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createHorizontalLine()));

		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createFluidContainer()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createNavigation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createTitle()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.CONTAINER__PAGECONTENTS,
				 BootstrapFactory.eINSTANCE.createFixContainer()));
	}
