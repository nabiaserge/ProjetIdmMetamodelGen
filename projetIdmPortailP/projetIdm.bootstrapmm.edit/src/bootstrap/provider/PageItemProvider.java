...
/**
 * This is the item provider adapter for a {@link bootstrap.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BootstrapPackage.Literals.PAGE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BootstrapPackage.Literals.PAGE__PAGECONTENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case BootstrapPackage.PAGE__NAME:
				...
				return;
			case BootstrapPackage.PAGE__PAGECONTENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BootstrapPackage.Literals.PAGE__PAGECONTENTS,
