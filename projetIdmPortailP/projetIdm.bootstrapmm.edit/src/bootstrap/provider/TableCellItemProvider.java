...
/**
 * This is the item provider adapter for a {@link bootstrap.TableCell} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableCellItemProvider extends TextContainerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableCell_alignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableCell_alignment_feature", "_UI_TableCell_type"),
				 BootstrapPackage.Literals.TABLE_CELL__ALIGNMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BootstrapPackage.Literals.TABLE_CELL__SPAN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((TableCell)object).getColor();
