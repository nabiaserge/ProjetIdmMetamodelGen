...
/**
 * This is the item provider adapter for a {@link ppuy1.Personne} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonneItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ppuy1Package.Literals.PERSONNE__NOM,
				 true,
				 false,
				 false,
	...
	protected void addPrenomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Personne_prenom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Personne_prenom_feature", "_UI_Personne_type"),
				 ppuy1Package.Literals.PERSONNE__PRENOM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Personne.class)) {
			case ppuy1Package.PERSONNE__NOM:
			case ppuy1Package.PERSONNE__PRENOM:
