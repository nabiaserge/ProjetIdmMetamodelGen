...
/**
 * This is the item provider adapter for a {@link ppuy1.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptionItemProvider extends ContenuItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ppuy1Package.Literals.DESCRIPTION__TEXT,
				 true,
				 false,
				 false,
	...
	protected void addLienPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_lien_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_lien_feature", "_UI_Description_type"),
				 ppuy1Package.Literals.DESCRIPTION__LIEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Description)object).getTitle();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Description.class)) {
			case ppuy1Package.DESCRIPTION__TEXT:
			case ppuy1Package.DESCRIPTION__LIEN:
